...
('Fixed stations, workstations', 'ChoiceType', 'Used;0;Not used functional;0;Neither used nor functional;0', 0, '', 'Workstation', '4'),
('Laptops, digital tablets', 'ChoiceType', 'Used;0;Not used functional;0;Neither used nor functional;0', 0, '', 'Workstation', '4'),
('Small printers (<15kg, potentially used by a household)', 'ChoiceType', 'Used;0;Not used functional;0;Neither used nor functional;0', 0, '', 'Workstation', '4'),
('Flat screen monitors', 'ChoiceType', 'Used;0;Not used functional;0;Neither used nor functional;0', 0, '', 'Workstation', '4'),
('Other flat screens (TV, projection screen, digital board ...)', 'ChoiceType', 'Used;0;Not used functional;0;Neither used nor functional;0', 0, '', 'Workstation', '4'),
('CRT monitors (monitors or other)', 'ChoiceType', 'Used;0;Not used functional;0;Neither used nor functional;0', 0, '', 'Workstation', '4'),
('Video projectors', 'ChoiceType', 'Used;0;Not used functional;0;Neither used nor functional;0', 0, '', 'Workstation', '4'),
('Mobile phones', 'ChoiceType', 'Used;0;Not used functional;0;Neither used nor functional;0', 0, '', 'Workstation', '4'),
('Fixed telephones (standalone not connected to such a standard)', 'ChoiceType', 'Used;0;Not used functional;0;Neither used nor functional;0', 0, '', 'Workstation', '4'),
('Digital cameras', 'ChoiceType', 'Used;0;Not used functional;0;Neither used nor functional;0', 0, '', 'Workstation', '4'),
('Hard Disk Devices, Storage, Backup', 'ChoiceType', 'Used;0;Not used functional;0;Neither used nor functional;0', 0, '', 'Workstation', '4'),
('Do you have other devices in your company?', 'ChoiceType', 'Yes;0;No;0', 0, 'Keyboards, mouse, graphic tablets, scanners, microphones, speakers, office equipment ...', 'Workstation', ''),
...
('Keyboards', 'ChoiceType', 'Used;0;Not used functional;0;Neither used nor functional;0', 0, '', 'Workstation', '5'),
('Mouse', 'ChoiceType', 'Used;0;Not used functional;0;Neither used nor functional;0', 0, '', 'Workstation', '5'),
('Graphic tablets', 'ChoiceType', 'Used;0;Not used functional;0;Neither used nor functional;0', 0, '', 'Workstation', '5'),
('Scanners', 'ChoiceType', 'Used;0;Not used functional;0;Neither used nor functional;0', 0, '', 'Workstation', '5'),
('Speakers', 'ChoiceType', 'Used;0;Not used functional;0;Neither used nor functional;0', 0, '', 'Workstation', '5'),
('Office automation', 'ChoiceType', 'Used;0;Not used functional;0;Neither used nor functional;0', 0, '', 'Workstation', '5'),
